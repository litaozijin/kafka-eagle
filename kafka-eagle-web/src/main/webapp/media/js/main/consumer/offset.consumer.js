$(document).ready(function() {
	...
	function offsetDetail() {
		$("#offset_topic_info").append("<div class='table-responsive' id='div_children" + offset + "'><table id='result_children" + offset + "' class='table table-bordered table-hover' width='100%'><thead><tr><th>Partition</th><th>LogSize</th><th>Offset</th><th>Lag</th><th>Lead</th><th>Owner</th><th>Created</th><th>Modify</th></tr></thead></table></div>");
		if (offset > 0) {
